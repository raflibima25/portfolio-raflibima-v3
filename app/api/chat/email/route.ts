    ...
    if (body.type === "REPLY_NOTIFICATION") {
      ...
      const htmlReply = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            ...
            <a href="${process.env.DOMAIN}/chat" style="${buttonStyle}">Buka Chat Room</a>
          </div>
          <div style="${footerStyle}">
            Sent by Rafli Bima Pratandra Portfolio System • www.raflibima.my.id • Jakarta, Indonesia
          </div>
        </div>
      `;

      await transporter.sendMail({
        from: `"Rafli Bima Pratandra" <${process.env.NODEMAILER_EMAIL}>`,
        to: targetEmail,
      ...
      const htmlNewChat = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            <p style="font-size: 16px; margin-top: 0;">Hi Rafli,</p>
            ...
            <a href="${process.env.DOMAIN}/chat" style="${buttonStyle}">Balas Sekarang</a>
          </div>
          <div style="${footerStyle}">
      ...
      await transporter.sendMail({
        ...
        to: process.env.NODEMAILER_EMAIL ?? "raflibima1106@gmail.com",
